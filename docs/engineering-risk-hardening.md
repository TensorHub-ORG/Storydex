...
- `coverage-baseline.json` 保存当前实际基线。前端基线迁移到 Vitest 4.1.10 / V8 AST-aware remapping 口径：lines 76.2、statements 75.5、functions 72.1、branches 65.6；后端基线为 lines 86.5、branches 73.7。
