...
.feedback-dialog { width: min(620px, 100%); max-height: min(760px, 92vh); overflow: auto; padding: 20px; border: 1px solid var(--border, var(--border-subtle)); border-radius: 8px; background: var(--panel-bg, var(--surface, var(--bg-card, #fff))); color: var(--text, var(--text-main)); box-shadow: 0 18px 48px rgb(0 0 0 / 28%); }
...
.feedback-field { display: grid; gap: 6px; margin-top: 16px; font-size: 13px; }.feedback-field input, .feedback-field select, .feedback-field textarea { width: 100%; box-sizing: border-box; padding: 9px 10px; border: 1px solid var(--border); border-radius: 6px; background: var(--input-bg, transparent); color: inherit; font: inherit; resize: vertical; }
.feedback-images { margin-top: 16px; }.feedback-image-add { width: 34px; height: 34px; display: grid; place-items: center; border: 1px solid var(--border); border-radius: 6px; cursor: pointer; }.feedback-image-add input { display: none; }
.feedback-preview-list { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px; margin-top: 10px; }.feedback-preview-list figure { position: relative; margin: 0; aspect-ratio: 4 / 3; overflow: hidden; border: 1px solid var(--border); border-radius: 6px; }.feedback-preview-list img { width: 100%; height: 100%; object-fit: cover; }.feedback-preview-list button { position: absolute; top: 2px; right: 2px; border-radius: 50%; background: rgb(0 0 0 / 60%); color: white; }
