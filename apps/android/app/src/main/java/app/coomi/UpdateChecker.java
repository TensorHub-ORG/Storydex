...
public final class UpdateChecker {
    ...
    private static final String UPDATE_URL =
        "https://updates.septemc.com/storydex/android/latest.json";
    ...
    public static void checkSilent(final Context context, final Callback callback) {
        new Thread(() -> {
            ...
            conn.setRequestProperty("User-Agent", "Storydex-Android/" + currentVersionCode(context));
    ...
    private static void downloadAndInstall(Context context, String apkUrl, String version) {
        ...
        String safeVersion = version.replaceAll("[^A-Za-z0-9._-]", "_");
            String fileName = "storydex-update-" + safeVersion + ".apk";

        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            request.setTitle("Storydex " + version);
